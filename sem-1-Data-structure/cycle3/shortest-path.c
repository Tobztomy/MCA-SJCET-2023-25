// Dijkstra's algorithm for single-source shortest paths using a mergeable heap structure 
// involves maintaining a priority queue of vertices based on their tentative distances from the source.
